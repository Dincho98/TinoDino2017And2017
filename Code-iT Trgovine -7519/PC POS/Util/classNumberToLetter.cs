    ...
    internal class classNumberToLetter
    {
        ...
        private string Hiljade(string jed, bool zenskirod)
        {
            if (jed == "1")
                ...
                return HrvatskiJezik ? "ŠESTTISUĆA " : "ŠESTHILJADA ";
            else if (jed == "7")
        ...
        private string Milioni(string jed, bool zenskirod)
        {
            if (jed == "1")
                ...
                return HrvatskiJezik ? "DVA MILIJUNA " : "DVA MILIONA ";
            else if (jed == "3")
                return HrvatskiJezik ? "TRI MILIJUNA " : "TRI MILIONA ";
            else if (jed == "4")
                return HrvatskiJezik ? "ČETIRI MILIJUNA " : "ČETIRI MILIONA ";
            else if (jed == "5")
                return HrvatskiJezik ? "PET MILIJUNA" : "PET MILIONA ";
            else if (jed == "6")
                return HrvatskiJezik ? "ŠEST MILIJUNA " : "ŠEST MILIONA ";
            else if (jed == "7")
                return HrvatskiJezik ? "SEDAM MMILIJUNA " : "SEDAM MILIONA";
            else if (jed == "8")
