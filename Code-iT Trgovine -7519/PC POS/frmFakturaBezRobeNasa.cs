...
namespace PCPOS
{
    public partial class frmFakturaBezRobeNasa : Form
    {
        ...
        {
            public static frmFakturaBezRobeNasa MainForm { get; set; }
        ...
        private void EnterDGW(DataGridView d)
        {
            ...
            {
                //d.CurrentCell = dgw.Rows[d.CurrentRow.Index].Cells[(chbSNBC.Checked ? 14 : 7)];
                d.CurrentCell = dgw.Rows[d.CurrentRow.Index].Cells[(7)];
                d.BeginEdit(true);
                //            } else if (d.CurrentCell.ColumnIndex == (chbSNBC.Checked ? 14 : 7))
            }
        ...
        {
            DataTable DSbr = classSQL.select("SELECT MAX(broj_fakture) FROM fakture WHERE id_ducan='" + id_ducan + "' AND id_kasa='" + id_kasa + "'", "fakture").Tables[0];
        ...
        private void btnSpremi_Click_1(object sender, EventArgs e)
        {
            ...
            DataTable dtZapisnikStavke = new DataTable();
            dtZapisnikStavke.Columns.Add("sifra");
            dtZapisnikStavke.Columns.Add("mpc");
            dtZapisnikStavke.Columns.Add("id_skladiste");
            ...
            for (int i = 0; i < dgw.Rows.Count; i++)
            {
                ...
                drRow["sifra"] = sifra;
                drRow["mpc"] = dg(i, "mpc");
                drRow["id_skladiste"] = dg(i, "skladiste");
            ...
            // Class.ZapisnikPromjeneCijene _zapisnik = new Class.ZapisnikPromjeneCijene(dtZapisnikStavke, false);
            ...
            string sql = "INSERT INTO fakture (broj_fakture,id_odrediste,id_fakturirati,date," +
                ...
                "ukupno_povratna_naknada,ukupno_mpc,ukupno_vpc,ukupno_mpc_rabat,ukupno_rabat,ukupno_osnovica,stavke_u_valuti,ukupno_porez,id_ducan,id_kasa,novo, editirano, partner_poslovnica)" +
                " VALUES " +
                " (" +
                " '" + ttxBrojFakture.Text + "'," +
                " '" + txtSifraOdrediste.Text + "'," +
            ...
            if (DTpostavke.Rows[0]["fiskalizacija_faktura_prikazi_obavijest"].ToString() == "True")
            {
        ...
        {
            frmSveFaktureBezRobeNase objForm2 = new frmSveFaktureBezRobeNase();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO ispis_fakture (broj_fakture,id_odrediste,id_fakturirati,date,dateDVO,datum_valute,id_izjava,id_zaposlenik,id_zaposlenik_izradio,model" +
                ",id_nacin_placanja,zr,id_valuta,otprema,id_predujam,napomena,id_vd,godina_predujma,godina_ponude,godina_fakture,oduzmi_iz_skladista,ukupno,id_kasa,id_ducan) VALUES " +
                " (" +
                 " '" + ttxBrojFakture.Text + "'," +
                " '" + txtSifraOdrediste.Text + "'," +
                " '" + txtSifraFakturirati.Text + "'," +
            ...
            for (int i = 0; i < dgw.Rows.Count; i++)
            {
                ...
                sql = "INSERT INTO ispis_faktura_stavke (kolicina,vpc,nbc,porez,broj_fakture,rabat,id_skladiste,sifra,povratna_naknada,oduzmi,id_kasa,id_ducan) VALUES " +
                    "(" +
