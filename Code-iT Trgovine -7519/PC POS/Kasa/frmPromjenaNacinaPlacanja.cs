...
namespace PCPOS.Kasa
{
    public partial class frmPromjenaNacinaPlacanja : Form
    {
        ...
        private void btnTrazi_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Greška kod upisa kartice.", "Greška"); return;
            }
            ...
            string sql = "UPDATE racuni SET ukupno_gotovina='" + txtGotovina.Text + "',ukupno_kartice='" + txtKartica.Text + "',dobiveno_gotovina='" + Convert.ToDecimal(txtGotovina.Text) + "' WHERE broj_racuna='" + txtBroj.Text + "'";
        ...
        private void txtBroj_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                DataTable dt = classSQL.select("SELECT * FROM racuni WHERE broj_racuna='" + txtBroj.Text + "'", "racuni").Tables[0];
