        ...
        private void btnNoviUnos_Click(object sender, EventArgs e)
        {
            if (txtGenerirano.Text != "")
            {
                ...
                if (generirano == txtGenerirano.Text)
                {
                    ...
                    {
                        bool rez = ws.Registracija(productKey, generirano, Util.Korisno.oibTvrtke, Class.PodaciTvrtka.nazivPoslovnice, Class.PodaciTvrtka.gradPoslovnicaId, Class.PodaciTvrtka.adresaPoslovnice, Util.Korisno.nazivPoslovnica, Convert.ToInt32(Util.Korisno.nazivNaplatnogUredaja));
                        if (rez)
                        {
