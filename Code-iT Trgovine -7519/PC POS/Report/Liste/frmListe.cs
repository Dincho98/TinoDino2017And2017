...
namespace PCPOS.Report.Liste
{
    public partial class frmListe : Form
    {
        ...
        {
            InitializeComponent();
            if (Class.Postavke.proizvodnjaMeduskladisnicaPC && dokument == "5ar")
            {
                //string s = this.reportViewer1.LocalReport.ReportPath.ToString();
                ...
                path = Path.Combine(directory, @"Report\Liste\Liste.rdlc").ToString();
                //string nameToFind = "tblItems";
                string rptxml = File.ReadAllText(path);
                int start = rptxml.IndexOf("<TablixColumns>");
                int end = rptxml.IndexOf("</TablixColumns>") + "</TablixColumns>".Length;
                string resizedColumns = string.Format(@"<TablixColumns>
            <TablixColumn>
              <Width>0.76695cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>2.12545cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>4.62608cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.00012cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.99234cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.54338cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.77731cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>2.71668cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.60929cm</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.8083cm</Width>
            </TablixColumn>
          </TablixColumns>");
        ...
        private void frmListe_Load(object sender, EventArgs e)
        {
            ...
            ReportParameter proizvodnja_meduskladisnica_pc = new ReportParameter("proizvodnja_meduskladisnica_pc", false.ToString());
            ReportParameter proizvodnja_normativ_pc = new ReportParameter("proizvodnja_normativ_pc", false.ToString());
            ...
            {
                meduskladisnica();
                proizvodnja_meduskladisnica_pc = new ReportParameter("proizvodnja_meduskladisnica_pc", Class.Postavke.proizvodnjaMeduskladisnicaPC.ToString());
                this.Text = ImeForme;
            }
            else if (dokument == "NORMATIV")
            {
                Normativ();
                proizvodnja_normativ_pc = new ReportParameter("proizvodnja_normativ_pc", Class.Postavke.proizvodnja_normativ_pc.ToString());
                this.Text = ImeForme;
            }
            ...
            this.reportViewer1.LocalReport.SetParameters(new ReportParameter[] { proizvodnja_meduskladisnica_pc, proizvodnja_normativ_pc });
            this.reportViewer1.RefreshReport();
        }
