...
{
    public partial class frmListeMeduskladisnicaPC : Form
    {
        public frmListeMeduskladisnicaPC()
        {
            InitializeComponent();
        }
        ...
        private void frmListe_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.SetParameters(proizvodnja_meduskladisnica_pc);
            this.reportViewer1.RefreshReport();
        }
        ...
        private void meduskladisnica()
        {
            ...
            string sql_liste = "SELECT " +
                ...
                " ROUND(roba.proizvodacka_cijena, 2) AS cijena7 ," +
