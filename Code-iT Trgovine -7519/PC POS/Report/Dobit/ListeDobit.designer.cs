namespace PCPOS.Report.Dobit
{
    partial class ListeDobit
    {
        ...
        private void InitializeComponent()
        {
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "PCPOS.Report.Dobit.ListeDobit.rdlc";
			...
			this.Name = "ListeDobit";
			this.Text = "Dobit";
			this.Load += new System.EventHandler(this.ListeDobit_Load);
