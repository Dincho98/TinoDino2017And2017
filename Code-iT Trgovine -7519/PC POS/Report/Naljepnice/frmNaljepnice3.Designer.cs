namespace PCPOS.Report.Naljepnice
{
	partial class frmNaljepnice3
	{
		...
		private void InitializeComponent()
		{
			...
			this.dSnaljepnice = new PCPOS.Dataset.DSnaljepnice3();
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "PCPOS.Report.Naljepnice.Naljepnice3.rdlc";
			...
			this.Name = "frmNaljepnice3";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Naljepnice";
			this.Load += new System.EventHandler(this.frmNaljepnice3_Load);
		...
		private Dataset.DSnaljepnice3 dSnaljepnice;
