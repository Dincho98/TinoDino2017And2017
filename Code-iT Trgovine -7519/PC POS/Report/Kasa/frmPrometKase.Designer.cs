namespace PCPOS.Report.Kasa
{
    partial class frmPrometKase
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dSKasaPromet = new PCPOS.Dataset.DSKasaPromet();
            this.reportViewer1 = new Microsoft.Reporting.WinForms.ReportViewer();
			this.dSkasaVrstaRobe = new PCPOS.Dataset.DSkasaVrstaRobe();
            this.dTvrstaRobeBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.dSkasaNacinPlacanja = new PCPOS.Dataset.DSkasaNacinPlacanja();
		...
		private Dataset.DSKasaPromet dSKasaPromet;
        private System.Windows.Forms.BindingSource dTkasaPrometBindingSource;
		private Dataset.DSkasaVrstaRobe dSkasaVrstaRobe;
        private System.Windows.Forms.BindingSource dTvrstaRobeBindingSource;
		private Dataset.DSkasaNacinPlacanja dSkasaNacinPlacanja;
