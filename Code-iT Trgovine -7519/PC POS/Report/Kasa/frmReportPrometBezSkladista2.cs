...
{
    public partial class frmReportPrometBezSkladista2 : Form
    {
        public frmReportPrometBezSkladista2()
        {
            InitializeComponent();
        }
        ...
        private void SetDS()
        {
            ...
            string sqlRacuni = "SELECT SUM(CAST(REPLACE(racun_stavke.kolicina,',','.') AS NUMERIC)) AS [kolicina]," +
                ...
                " Round(racun_stavke.mpc_rabat, 2) AS mpcRabat," +
                ...
                " AND racuni.datum_racuna<'" + datumDO + "'" +
                blag + duc + art +
                " GROUP BY roba.naziv,racun_stavke.sifra_robe, racun_stavke.rabat, racun_stavke.nbc, racun_stavke.mpc, racun_stavke.mpc_rabat, racun_stavke.vpc";
        ...
        private void SrediPoreze1(ref decimal UG, ref decimal UK, ref decimal UV, string[] blagDucArt)
        {
            ...
            foreach (DataRow r in DT.Rows)
            {
                ...
                if (iznos != stavkaGotovina + stavkaKartice + stavkaVirman)
        ...
        {
            string sql = "SELECT SUM(racuni.ukupno_mpc) " +
                "as kolicinaPutaMpc " +
                "FROM racuni  " +
                "WHERE racuni.datum_racuna>'" + datumOD + "'" +
                " AND racuni.datum_racuna<'" + datumDO + "'";
        ...
        {
            string sql = "SELECT SUM(racuni.ukupno_mpc_rabat) " +
                "as kolicinaPutaMpc " +
                "FROM racuni  " +
                "WHERE racuni.datum_racuna>'" + datumOD + "'" +
                " AND racuni.datum_racuna<'" + datumDO + "'";
        ...
        {
            string sql = "SELECT SUM(racuni.ukupno_vpc)" +
                "as kolicinaPutaVpc " +
                "FROM racuni  " +
                "WHERE racuni.datum_racuna>'" + datumOD + "'" +
                " AND racuni.datum_racuna<'" + datumDO + "'";
        ...
        {
            string sql = "SELECT SUM(racuni.ukupno_rabat) " +
                "as Rabat " +
                "FROM  racuni  " +
                "WHERE racuni.datum_racuna>'" + datumOD + "'" +
                " AND racuni.datum_racuna<'" + datumDO + "'";
