...
namespace PCPOS.synWeb
{
    internal class synSkladista
    {
        ...
        public synSkladista(bool _posalji_sve)
        {
        ...
        public void Send()
        {
            ...
            if (posalji_sve)
                if (MessageBox.Show("Želite poslati skladista?", "Sinkronizacija", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                {
                    return;
                }
