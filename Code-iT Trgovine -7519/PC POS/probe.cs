    ...
    public partial class probe : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < DT5.Rows.Count; i++)
            {
                ...
                //double postotak = (1 + Convert.ToDouble(DT5.Rows[i]["porez"].ToString()) + Convert.ToDouble(DT5.Rows[i]["porez_potrosnja"].ToString())))/100;
            ...
            for (int i = 0; i < DT.Rows.Count; i++)
            {
                ...
                double postotak = (1 + (Convert.ToDouble(DT.Rows[i]["porez"].ToString()) + Convert.ToDouble(DT.Rows[i]["porez_potrosnja"].ToString()))) / 100;
